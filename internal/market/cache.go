...
func (c *CachingHistory) key(symbol string, res Resolution) string {
...
func (c *CachingHistory) Candles(ctx context.Context, symbol string, res Resolution, from, to time.Time) ([]Candle, error) {
