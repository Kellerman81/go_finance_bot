...
var detectorRegs = []detectorReg{
	{"ema_cross", []string{"ema", "macross"}, func(c config.StrategyConfig) Detector { return newEMACrossDetector(c) }},
	...
	{"bollinger", []string{"bbands", "bb"}, func(c config.StrategyConfig) Detector { return newBollingerDetector(c) }},
	...
	{"rvol", []string{"relvol"}, func(c config.StrategyConfig) Detector { return newRVOLDetector(c) }},
	{"volume_profile", []string{"vp", "volumeprofile"}, func(c config.StrategyConfig) Detector { return newVolumeProfileDetector(c) }},
	{"trend", []string{"linreg", "regression"}, func(c config.StrategyConfig) Detector { return newTrendDetector(c) }},
	{"adx", []string{"dmi"}, func(c config.StrategyConfig) Detector { return newADXDetector(c) }},
	{"stochastic", []string{"stoch"}, func(c config.StrategyConfig) Detector { return newStochasticDetector(c) }},
	{"supertrend", []string{"st"}, func(c config.StrategyConfig) Detector { return newSupertrendDetector(c) }},
	{"donchian", []string{"dc"}, func(c config.StrategyConfig) Detector { return newDonchianDetector(c) }},
}
